...
**ステップ 3-A.** rbenv を使って Ruby と Ruby on Rails をインストール(OS X 10.9 以上の場合):
...
**ステップ 3-B.** 使用している OS Xのバージョン用 RailsInstaller ダウンロードします。(OS X10.6, 10.7, 10.8の場合)

* [10.9 以上 用 RailsInstaller](http://railsinstaller.s3.amazonaws.com/RailsInstaller-1.0.4-osx-10.7.app.tgz) <span class="muted">(325MB)</span>
